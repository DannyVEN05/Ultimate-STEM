...
const ProfilePage: React.FC = () => {
  ...
  const BookCard = () => {
    return (
      <div className="relative flex h-full w-full bg-secondary/30 shadow-md border border-gray-200 rounded-lg p-4 gap-4 hover:shadow-xl transition-shadow hover:bg-secondary/50 transition-colors">
        <div className="absolute top-2 right-2">
          <Button variant="outline" className="h-8 w-8 p-0 rounded-full">
            Edit
          </Button>
        </div>
        <div className="flex-1 border flex-1 bg-white shadow-md border border-gray-200 rounded-lg hover:shadow-xl transition-shadow transform transition-transform hover:-translate-y-1"></div>
        <div className="flex-1 flex flex-col flex-1 gap-2">
  ...
  return (
    <div className="px-4 h-full flex flex-col min-h-0">
      ...
      <div className="flex gap-4 justify-center items-center mb-2">
        ...
        <h1 className="relative flex-3 text-3xl font-bold text-center">
          My Submissions
