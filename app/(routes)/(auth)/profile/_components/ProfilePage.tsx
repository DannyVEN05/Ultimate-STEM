    ...
    <div className="mx-36 h-full flex flex-col min-h-0">
      ...
      <div className="flex gap-38 h-full min-h-0">
        <div className="flex flex-col flex-1 pl-2">
          <div className="flex-[5] my-2 mr-2 ml-2 border border-gray-200 shadow-xs rounded-xl justify-center items-center flex flex-col p-4 bg-gradient-to-b from-secondary/50 to-white hover:from-secondary/70 hover:to-secondary/10 transition-colors hover:shadow-md">
