...
export type BookContextType = {
  ...
  // This function updates the submission_likes table inserting or deleting a composite key of user_id and tournamentsub_id. An Agggregate COUNT() can be applied to retrieve the number of likes
